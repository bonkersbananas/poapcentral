...
#		  \e[90m$$ \e[0;97;1mmake \e[0;92;1mbuild         \e[0;90m➔ \e[32;3mbuild \e[0m\n \
...
.PHONY: bun-install
bun-install:
	@runcmd bun install --cwd frontend/
...
docker-compose-up:
	docker-compose up --project-name poapcentral --force-recreate || (exit_code=$$?; [ $$exit_code -eq 130 ] || exit $$exit_code) ; docker-compose down
